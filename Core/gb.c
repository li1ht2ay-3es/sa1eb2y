...
const GB_palette_t GB_PALETTE_DMG  = {{{0x08, 0x18, 0x10}, {0x39, 0x61, 0x39}, {0x84, 0xA5, 0x63}, {0xC4, 0xDC, 0x8A}, {0xD0, 0xE4, 0xA4}}};
//const GB_palette_t GB_PALETTE_MGB  = {{{0x07, 0x10, 0x0E}, {0x3A, 0x4C, 0x3A}, {0x81, 0x8D, 0x66}, {0xC2, 0xCE, 0x93}, {0xCF, 0xDA, 0xAC}}};
const GB_palette_t GB_PALETTE_MGB  = {{{0x08, 0x11, 0x0F}, {0x3C, 0x4E, 0x3C}, {0x83, 0x8F, 0x67}, {0xC0, 0xCC, 0x91}, {0xCD, 0xD8, 0xAA}}};
